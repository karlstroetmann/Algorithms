...
\noindent
\textbf{L�sung}:
Das Einf�gen und L�schen in einem AVL-Baum unterscheidet sich von dem Einf�gen und L�schen
in einem bin�ren Baum durch die zus�tzliche Anwendung der Funktion $\textsl{rstore}()$.
...
\item $\begin{array}[t]{cl}
       ...
       $
\end{enumerate}
Damit lautet die L�sung der Aufgaben:
\begin{enumerate}
\item Zun�chst f�gen wir den Schl�ssel 13 ein, ohne auf die Balancierungs-Bedingung zu
      achten.  Wir erhalten den folgenden Term, wobei wir die Knoten noch mit ihren H�hen
      annotieren, um sp�ter die Balancierungs-Bedingung �berpr�fen zu k�nnen:
      \\[0.2cm]
      \hspace*{1.3cm}
      $t = n(17, n(8, n(2, *, *):1,
                    n(10, n(13, *, *):1, *):2):3,$ \\
      ...
      Knotens verletzt ist, denn der linke Teilbaum hat eine Tiefe von drei, w�hrend der
      rechte Teilbaum eine Tiefe von 1 hat.  Da der rechte Teilbaum des linken Teilbaums
      eine gr��ere Tiefe hat als der linke Teilbaum, liegt die in Gleichung 4 beschriebene
      ...
      \hspace*{2.75cm} $
                n(17, *,n(23, *,*)))$
\item F�gen wir den Schl�ssel 15 ein, so erhalten wir 
      \\[0.2cm]
      \hspace*{1.3cm}
      $t = n(10, 
                n(8, 
...
\item Nachdem wir den Schl�ssel $2$ entfernt haben, hat der Baum die Form
      \\[0.2cm]
      \hspace*{1.3cm}
      $t = n(10, 
                n(8, 
...
\item Wir zeigen als erstes, dass die \texttt{while}-Schleife der Invariante 
      ...
      F�r die erste Zuweisung in der Schleife gilt
      \\[0.2cm]
      \hspace*{1.3cm}
      ...
      \end{eqnarray*}
      Als n�chstes betrachten wir die Zuweisung \texttt{i = i + 1;}:
      \\[0.2cm]
      \hspace*{1.3cm}
...
\item Die Invariante ist zu Beginn der Schleife erf�llt, denn zu Beginn der
