...
public class Calculator 
{
    ...
    public Calculator()
    {
        ...
        while (!mTokenStack.isEmpty()) {
            if (mTokenStack.top() instanceof Zahl) {
                BigInteger number = ((Zahl) mTokenStack.top()).getZahl();
                mTokenStack.pop();
                mArguments.push(number);
                continue;
            } 
            String nextOp = ((Operator) mTokenStack.top()).toString();
            mTokenStack.pop();
            ...
            if (stackOp.equals("(") && nextOp.equals(")") ) {
                ...
                popAndEvaluate();
                mTokenStack.push(new Operator(nextOp));
