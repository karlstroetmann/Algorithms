...
public class MyScanner {
	...
	public MyScanner (java.io.Reader reader) {
		this ();
		if (null == reader) {
	...
	public MyScanner (java.io.InputStream instream) {
		this ();
		if (null == instream) {
			throw (new Error("Error: Bad input stream initializer."));
		}
