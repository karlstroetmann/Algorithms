...
public class AnimationFrame extends JFrame
{
    ...
    /** Construct the frame for the animation.
		@param genRandom If this is true, the tree is generated from random numbers.
		                 Otherwise, the keys are sorted, so that the resulting tree will 
					     degrade into a list.
	 */
    public AnimationFrame(boolean genRandom) {
    ...
    public static void main(String[] args) {
        ...
        // JFrame frame = new AnimationFrame(true);
        JFrame frame = new AnimationFrame(random);
