...
implementation of this algorithm, the notion of an \blue{abstract data type} abstracts from the implementation
...
to evaluate \blue{arithmetic expressions}.  Abstract data types were proposed by
