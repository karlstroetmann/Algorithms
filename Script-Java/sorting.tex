...
\item Gesucht ist eine Liste $S$ mit folgenden Eigenschaften: 
  ...
  \item Die Elemente treten in $L$ und $S$ mit derselben Häufigkeit auf: \\[0.2cm]
        \hspace*{1.3cm} 
...
Durch eine einfache Induktion lässt sich sofort nachweisen, dass diese Rekurrenz-Gleichung
 die Lösung \\[0.2cm]
...
$
\\[0.2cm]
denn $b_0 = 0$ und für die Summe der Zahlen von 0 bis $n - 1$ lässt sich die Gleichung
\\[0.2cm]
\hspace*{1.3cm}
...
also muss $\beta = 1$ gelten.  Damit lautet die Lösung \\[0.2cm]
