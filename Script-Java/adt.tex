...
\item $\textsl{Ts}$ ist eine Menge von \emph{Typ-Spezifikation}, die zu jedem Funktions-Zeichen
      ...
      $T_i$ sein muß.  Außerdem sagt die Typ-Spezifikation aus, dass das
...
\end{enumerate}
Beim Betrachten der Axiome läßt sich eine gewisse Systematik erkennen.
...
der Operator \texttt{op1} vor dem Operator \texttt{op2} ausgewertet werden muß.
...
\item Abstrakte Daten-Typen machen die Implementierung eines Algorithmus von der
      ...
      mußten wir uns um die zugrunde liegenden Daten-Strukturen nicht weiter kümmern. 
...
\item Abstrakte Daten-Typen sind \emph{austauschbar}.
      ...
      läßt.  In einem späteren Schritt wird evaluiert wo der Schuh am meisten drückt.
...
%\emph{Stack} sich in \textsc{Setl2} mit Hilfe einer Klasse implementieren läßt.  Alle
...
%abgespeichert.  Um diesen Daten-Typ auch nutzen zu können, muß ein Programm die Direktive \\[0.1cm]
