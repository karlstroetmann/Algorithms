...
Interface beschreiben läßt.  Das Interface hat den Namen \textsl{MyMap}, denn da der ADT
...
kann, muß die Methoden \textsl{insert()} statt dessen den binären Baum, der durch das
