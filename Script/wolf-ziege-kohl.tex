...
Wenn er den Wolf mit der Ziege allein läßt, dann frißt der Wolf die Ziege und wenn er die
...
\item Der Aufruf $c.\textsl{compareTo}(s)$ vergleicht die Menge $c$ mit der Menge $s$.
      ...
      Falls die Ordnung auf den Elementen eine totale Ordnung ist, so läßt sich zeigen,
...
die selben Funktionen wie in \textsl{Setl} zur Verfügung stehen, können wir nun daran
