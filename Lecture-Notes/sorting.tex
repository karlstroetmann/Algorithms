...
\blue{sorted descendingly}\index{sorted descendingly}, because then the element $x$ that is inserted in
...
\\[0.2cm]
The proof is done by induction on $\mathtt{len}(L_1) + \mathtt{len}(L_2)$.
\begin{enumerate}
\item[I.A.:] $\mathtt{len}(L_1) + \mathtt{len}(L_2) = 0$.
             ...
             \\[0.2cm]
             \hspace*{1.3cm}
             $\mathtt{cmpCount}(L_1, L_2) = 0 \leq 0 = \mathtt{len}(L_1) + \mathtt{len}(L_2)$.
\item[I.S.:] $\mathtt{len}(L_1) + \mathtt{len}(L_2) = n+1$.
             ...
             \\[0.2cm]
             \hspace*{1.3cm}
             $\mathtt{cmpCount}(L_1,L_2) = 0 \leq \mathtt{len}(L_1) + \mathtt{len}(L_2)$.
             \\[0.2cm]
