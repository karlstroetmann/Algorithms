...
recurrence equations interchangeably.  In this section we discuss a simple program whose complexity analysis
...
\\[0.2cm]
\hspace*{1.3cm}
$\ds \mathrm{e}^{i \cdot \pi} = \cos(x) + i \cdot \sin(x)$
\\[0.2cm]
...
\item What is the ansatz to solve a linear homogeneous recurrence equation?
\item Describe the method to solve a linear inhomogeneous recurrence equation!
