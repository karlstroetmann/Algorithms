...
\begin{Proposition}[Distributivit\"at von \texttt{count} \"uber \texttt{sort}] \hspace*{\fill}\\
{\em
...
\begin{Proposition}[Distributivit\"at von \texttt{count} \"uber \texttt{sort}] \hspace*{\fill} \\[0.1cm]
{\em
...
\begin{Proposition}[Vertr\"aglichkeit von \texttt{isSorted} und \texttt{sort}] \hspace*{\fill} \\
{\em
...
\begin{Proposition}[Vertr\"aglichkeit von \texttt{count} und \texttt{sort}] \hspace*{\fill} \\
{\em
...
Anschlie\3end rufen wir in Zeile 21 die Methode \texttt{merge} aus, die die beiden
...
\item Die Schwierigkeit bei der Implementierung von \emph{Quick-Sort} liegt
      ...
      \emph{Pivot-Element} aus.  Anschlie\3end l\"auft der Index \texttt{leftIdx} ausgehend von
