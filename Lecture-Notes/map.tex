...
\blue{Sets} and \blue{dictionaries} are among the most useful data structures.  As evidence for this claim I
cite the fact that all modern programming languages support these data structures.
The abstract concept that is implemented as a dictionary in \textsl{Python} is known as a \blue{map}
\index{map} in theoretical computer science. 
...
$v_{\textrm{min}}$ denotes the corresponding value.  Note that $t'$ is again ordered:
\begin{enumerate}
