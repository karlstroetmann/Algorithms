...
\begin{Definition}[Bin\"are B\"aume] \hspace*{\fill} \\
{\em
...
\begin{Definition}[Geordnete bin\"are B\"aume] \hspace*{\fill} \\
{\em
...
\item Ein Baum der Form $\textsl{Node}(k,v,l,r)$ wird dargestellt,  indem zun\"achst ein
      ...
      Anschlie\3end wird links unten von diesem Knoten rekursiv der Baum $l$ ge\-zeich\-net
...
%      Die H\"ohe des Baums $\textsl{node}(k,v,l,r)$ ist um eins gr\"o\3er als die H\"ohe des
%      gr\"o\3ten Teilbaums.
%\end{enumerate}
...
%Die H\"ohe eines Baumes gibt ein Ma\3 f\"ur die Komplexit\"at der Methoden \textsl{find},
