...
\colorbox{orange}{\blue{binary search trees}}. 
...
\colorbox{orange}{\blue{binary trees}} first.
...
\begin{Definition}[Binary Trees] \hspace*{\fill} \\
  ...
  \item $\textsl{Node}(k, v, l, r)$ is a binary tree if the following holds true: 
        ...
        \item $l$ is a binary tree.
              ...
              $l$ is the  \colorbox{orange}{\blue{left subtree}} of the tree $\textsl{Node}(k, v, l, r)$.
        \item $r$ is a binary tree.

              $r$ is the \colorbox{orange}{\blue{right subtree}} of the tree $\textsl{Node}(k, v, l, r)$.
              \eox
        \end{enumerate}
  \end{enumerate}
\end{Definition}
...
\noindent
Next, we define the notion of an  \colorbox{orange}{\blue{ordered binary tree}}.
\begin{Definition}[Ordered Binary Tree] \hspace*{\fill} \\
  ...
  \item $\textsl{Node}(k, v, l, r) \in \Bin_<$ \quad iff the following conditions hold:
        ...
        \end{enumerate}
        The last two conditions are known as the \colorbox{orange}{\blue{ordering conditions}}.
        \eox
  \end{enumerate}
\end{Definition}
...
\item A binary tree of the form $\textsl{Node}(k,v,l,r)$ is represented by an oval.  Inside of this
      ...
      \colorbox{orange}{\blue{node}} of the binary tree. 
...
node that has the key $8$ and the value $22$ is called the \colorbox{orange}{\blue{root}} of the binary tree.
A \colorbox{orange}{\blue{path of length}} $k$ in the tree is  list $[n_0,n_1, \cdots, n_k]$ of
