...
\item Usage of \textsl{Python} is widespread.
  ...
  \item The \href{https://pypl.github.io/PYPL.html}{\textsc{Pypl}} (\blue{PopularitY of programming languages})
        index list \textsl{Python} on the first place.
  \end{enumerate}
\item It has a number of advanced features like \blue{garbage collection} and \blue{matching} that make it very easy to
...
\item After that, I present a \textsl{\blue{Jupyter notebook}} that introduces most of the features of
