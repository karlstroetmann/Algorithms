...
\item \href{http://en.wikipedia.org/wiki/Computational_complexity_theory}{Complexity} \index{complexity} of algorithms
      ...
      that the computation of $f(x)$ does not consume too much \blue{time}, \blue{memory}, or \blue{energy}.
      Hence, we have to develop \blue{efficient} algorithms.  In order to be able to discuss the concept of
      \blue{efficiency} we need to discuss the \blue{growth rate} of functions.  This notation is useful to abstract from
...
\item Recurrence Relations
      ...
      defines a sequence of natural numbers.  The numbers $a_n$ for $n = 1,\cdots,8$ are given as follows:
      \\[0.2cm]
      \hspace*{1.3cm}
      $a_0 = 0$, $a_1 = 1$, $a_2 = 1$, $a_3 = 2$, $a_4 = 3$, $a_5 = 5$, $a_6 = 8$, $a_7 = 13$, $a_8 = 21$. 
      \\[0.2cm]
      Later, we will see that this sequence can also be computed by
      \href{https://en.wikipedia.org/wiki/Fibonacci_number#Closed-form_expression}{Binet's formula}:
      \\[0.2cm]
      \hspace*{1.3cm}
...
\item \href{http://en.wikipedia.org/wiki/Graph_theory}{Graph theory}
      ...
      \item an algorithm to solve the \blue{union-find problem}\footnote{
              The \blue{union-find problem} is the problem to compute the smallest \blue{equivalence relation}
...
a \blue{philosophical idea} and a \blue{text} that describes the idea.  If you have a philosophical idea, you
...
\item Algorithms should be \blue{efficient} with respect to both \blue{computing time}, \blue{memory}, and,
      last not least, \blue{energy consumption}.
