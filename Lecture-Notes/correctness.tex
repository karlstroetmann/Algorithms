...
In this chapter we will show two different methods that can be used to prove the correctness of an algorithm.
\begin{enumerate}[(a)]
...
In this chapter we  verify the correctness of this function definition.
...
\begin{Verbatim}[ frame         = lines, 
    ...
    \green{def} \blue{power}(x$_1$, y$_1$):
        r$_1$ = 1
        \green{while} y$_n$ > 0:
            \green{if} y$_n$ % 2 == 1:
                r$_{n+1}$ = r$_n$ * x$_n$
