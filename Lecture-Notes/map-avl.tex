...
equation derived above we first solve the corresponding \blue{homogeneous recurrence equation} 
\\[0.2cm]
\hspace*{1.3cm}
$a_{h+2} = a_{h+1} + a_h$
\\[0.2cm]
...
\raisebox{-4pt}{\epsfig{file=Abbildungen/google.eps, scale=0.1}}, you are using a
