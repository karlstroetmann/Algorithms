...
\\[0.2cm]
Then, the function \textsl{code} maps the set of all non-empty strings with at most eighth characters in a
...
\item Rather than storing the values associated with the keys in an array, the values are now stored
      ...
      \\[0.2cm]
      Then, \texttt{array[idx]} returns a linked list containing a pairs of the form $\langle k', v' \rangle$.
