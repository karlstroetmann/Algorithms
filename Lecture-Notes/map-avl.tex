...
Figure \ref{fig:hashTable.stlx-hashCode} gives the implementation of the method $\texttt{hashCode}$.
\begin{enumerate}
...
Figure \ref{fig:hashTable.stlx-find} shows the implementation of the method $\texttt{find}$.
\begin{enumerate}
