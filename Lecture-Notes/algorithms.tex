...
\title{\epsfig{file=Abbildungen/dhbw-logo.eps, scale=1.2}\\[0.3cm]  
       An Introduction to Algorithms  \\[0.5cm]
      --- Lecture Notes for the Winter Term 2022 ---}
...
via \href{https://github.com}{GitHub}. \\[0.2cm]
\hspace*{0.5cm}
We will be using \href{https://deepnote.com}{Deepnote} as a Cloudservice.  This service provides free computing
