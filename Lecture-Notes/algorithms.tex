...
\title{\epsfig{file=Abbildungen/dhbw-logo.eps, scale=1.5}\\[0.3cm]  
       Algorithms  \\[0.5cm]
      --- Lecture Notes for the Summer Term 2017 ---}
...
Using this command will be necessary as their will be frequent changes of these lecture notes.
\end{minipage}
}
