...
eingegeben haben, schlie\3en wir die Eingabe ab indem wir ein \framebox{\texttt{Return}} eingeben 
...
\item \framebox{\texttt{Ctrl-Leertaste}} startet die \textsl{Java}-Vervollst\"andigung.
      ...
      es durch Bet\"atigen des \framebox{\texttt{Escape}}-Taste schlie\3en.
\item \framebox{\texttt{Ctrl-K}} und \framebox{\texttt{Ctrl-L}} aktiviert das sogenannte
      ...
      dieses Wortes einzugeben und anschlie\3end die Taste \framebox{\texttt{Ctrl-K}} oder
