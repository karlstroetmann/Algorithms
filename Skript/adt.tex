...
\item In der n\"achsten Phase verarbeiten wir die einzelnen Tokens des Token-Stacks
      ...
      \item Falls das  Token eine schlie\3ende Klammer \texttt{\symbol{34})\symbol{34}} ist und wenn zus\"atzlich
...
%      dann die Deklarationen der verschiedenen Prozeduren, die die Klasse nach au\3en zur
...
%            au\3erhalb der Klasse nicht sichtbar und k\"onnen nur innerhalb der Klasse
