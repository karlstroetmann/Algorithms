...
Wird ein Knoten eingefügt, so muß im Mittel weniger als 1 Knoten 
aufgespaltet werden!
...
\item Der Vater--Knoten ist ein 4--Knoten
    ...
    \end{enumerate}
\end{enumerate}
Zusätzlich muß noch unterschieden werden, ob der Bruder rechts oder links
...
\item[4.] \texttt{length \% 2 == 0, length > 2}:
  ...
  \end{enumerate}
\end{enumerate}
\textbf{Wichtig}: Bei den beiden rekursiven Aufrufen muß die Zahl \\
\hspace*{2.7cm} der übergebenen Schlüssel die selbe sein!
