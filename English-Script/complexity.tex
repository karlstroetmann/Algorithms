...
finden läßt.  Dazu betrachten wir das charakteristische Polynom \\[0.1cm]
\hspace*{1.3cm} 
...
\item $\mathtt{sp}(\chi) \not= 0$.
      ...
      Den Wert von $\delta$ bestimmen wir durch Einsetzen, es muß für alle $n\in \mathbb{N}$ gelten: \\[0.1cm]
      \hspace*{1.3cm} 
...
\begin{Proposition}[Reflexivität]
{\em
...
\begin{Proposition}[Abgeschlossenheit unter Multiplikation mit Konstanten] \hspace*{\fill} \\
{\em
...
\begin{Proposition}[Abgeschlossenheit unter Addition]
{\em
...
\begin{Proposition}[Transitivität]
{\em
  Es seien $f,g,h \colon \N \rightarrow {\R_+}$.  Dann gilt \\[0.1cm]
...
\begin{Proposition}[Grenzwert-Satz] \label{limit}
{\em
...
läßt sich durch folgende Formel beschreiben: \\[0.1cm] 
\hspace*{1.3cm} 
$m^n = 
\left\{\begin{array}{ll}
...
rekursiven Aufruf in Zeile $5$ anfallen, hinzu addiert werden muß.  Damit erhalten wir
die folgende Rekurrenz-Gleichung: \\[0.1cm]
...
Es gibt Situationen, in denen der Hauptsatz nicht anwendbar ist.  Beispielsweise läßt sich der Hauptsatz nicht
