...
\item Finally, we can try to describe algorithms in the language of mathematics.  This language is 
      ...
      simple to implement this algorithm in the programming language \textsc{SetlX}.  The reason is
...
\\[0.2cm]
\hspace*{1.3cm}
\href{http://wwwlehre.dhbw-stuttgart.de/~stroetma/Algorithms/algorithms.pdf}{http://wwwlehre.dhbw-stuttgart.de/\symbol{126}stroetma/Algorithms/algorithms.pdf}.  
\\[0.2cm]
...
of the time, my answers will be lies.  The other 50\% my answer will be either dirty lies or
accidentally true.
