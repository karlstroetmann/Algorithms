...
häufig auftreten, mit möglichst wenig Bits kodiert werden, während Buchstaben, die seltener
...
Kodierungs-Baum einen String zu kodieren, wenn die Häufigkeiten, mit denen ein Buchstabe
