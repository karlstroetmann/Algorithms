...
\item In line 2 we check whether the balancing condition is satisfied.  If we are lucky,  this test 
      ...
      same height.  However, the height of the complete tree has also shrink by one and therefore, 
...
bugs\footnote{Da habe ich schon Pferde kotzen sehen,  direkt vor der Apotheke.}.  
If, instead, a good
...
Both \texttt{C++} and \textsl{Java} supply maps.  In \texttt{C++}, maps are part of the standard
